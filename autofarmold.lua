...
if 1 == 1 then
	loadstring(game:HttpGet("https://raw.githubusercontent.com/donatehack/script_not_my/main/old.lua"))()
	return
end
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/donatehack/script_not_my/main/hookwscripts.lua"))()
task.wait()
  --Anti-AFK
...
local httpservice = game:GetService('HttpService')
queueonteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/donatehack/script_not_my/main/autofarmold.lua'))()")
